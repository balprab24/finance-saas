...
export function AccountFilter() {
  ...
  return (
    <Select value={accountId} onValueChange={onChange} disabled={accountsLoading || summaryLoading}>
      <SelectTrigger className="h-11 w-full rounded-full border border-[var(--aurex-border)] bg-[var(--aurex-surface)] px-4 text-[13px] font-medium text-[var(--aurex-text-1)] transition-colors hover:bg-[var(--aurex-surface-hover)] hover:border-[var(--aurex-border-strong)] lg:h-9 lg:w-auto">
